...
| Factory/APP Cobb-Douglas construct | `R=sigma(.024 ln zeta-.026 ln epsilon+.040 ln phi-.060 ln tau-.1771 ln kappa_dot)` | Published exponents are dimensionless and calibrated for a factory APP construct; they are not MFSC order-level ReT weights. | Garrido, Ponguta & Garcia-Reyes (2025; online 2024) | Construct-sensitivity only for current Paper 2. It cannot rescue a canonical `ret_excel_visible_v1` null and cannot be transferred to spatial allocation without a new validation study. |
