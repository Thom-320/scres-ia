...
CELL_KNOBS = code(
    ...
    "ORDER_UP_TO_MULTIPLIER = 1.0   # 1.0 = faithful order-up-to (order exactly to the It,S\n"
    "                               #   target). Static calibration (2026-06-17) showed 2.0\n"
    "                               #   OVER-provisions 2x and FLOORS the tail (p10=0 for all);\n"
    "                               #   1.0 un-floors it (p10 spans 0.0..0.69 across policies),\n"
    "                               #   so the inventory decision matters = where L_{t-1} can pay.\n"
    "STOCHASTIC_PT = True\n"
