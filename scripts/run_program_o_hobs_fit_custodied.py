#!/usr/bin/env python3
"""Run the Program O H_obs fit producer and always record its exit."""
...
def main() -> int:
    ...
    command = [
        sys.executable,
        str(ROOT / "scripts/screen_program_o_hobs_fit.py"),
        "--contract",
    ...
    write_json_atomic(
        ...
        {
            "schema_version": "program_o_hobs_fit_producer_exit_v1",
            ...
            "seed_claim": str(args.seed_claim.resolve()),
        },
    )
    return returncode
