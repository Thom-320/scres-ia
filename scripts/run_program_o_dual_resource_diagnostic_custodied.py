#!/usr/bin/env python3
"""Run the frozen dual-resource diagnostic and always record producer exit."""
...
def main() -> int:
    ...
    command = [
        sys.executable,
        str(ROOT / "scripts/diagnose_program_o_state_rich_dual_resource.py"),
        "--contract",
        ...
        "--output",
        str(run_dir / "artifacts" / "diagnostic"),
    ]
    started = now_utc()
    returncode = 1
    error = None
    ...
    write_json_atomic(
        ...
        {
            "schema_version": "program_o_dual_resource_diagnostic_producer_exit_v1",
