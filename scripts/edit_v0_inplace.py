...
print(
    f"Removed {len(elements_to_remove_42)} old placeholder paragraphs from section 4.2"
)
...
# Table 5 caption
section_33_content.append(
    create_paragraph("Table 5. Observation vector (v1) for the RL agent.")
)
...
section_33_content.append(
    create_table(
        ...
        [
            ...
            [
                "14",
                "contingent_demand_norm",
                "Pending contingent demand / 2600",
                "[0, 1]",
            ],
        ],
    )
    ...
    create_table(
        ...
        [
            [
                ...
                "Dispatch quantity at Op3",
            ],
            [
                "1",
                "op9_q_max",
                "multiplier = 1.25 + 0.75 \u00d7 signal",
                "Upper dispatch at Op9",
            ],
            [
                "2",
                "op3_rop",
                "multiplier = 1.25 + 0.75 \u00d7 signal",
                "Reorder point at Op3",
            ],
            [
                "3",
                "op9_rop",
                "multiplier = 1.25 + 0.75 \u00d7 signal",
                "Reorder point at Op9",
            ],
            [
                "4",
                "shifts",
...
section_33_content.append(
    create_paragraph("3.3.3 Decision Epoch and Horizon", italic=True)
)
section_33_content.append(
    create_paragraph(
...
for label, text in [
    (
        ...
        " Under control_v1, the trained agent uses a mix of shifts (12% S1, 25% S2, 63% S3 under increased risk), demonstrating genuine adaptive behavior. Under ReT_thesis, the agent collapsed to 99.99% S1.",
    ),
    (
        "Service preservation:",
        " control_v1-trained agents maintain fill rates comparable to the best static baselines (0.84 under increased risk, 0.63 under severe risk). ReT_thesis-trained agents degraded fill rate to 0.84 even under current (low) risk.",
    ),
    (
        "Interpretability:",
        " Each component of control_v1 maps directly to an observable operational quantity, making the reward transparent to supply chain practitioners.",
    ),
]:
...
# 4.2.1
section_42_content.append(
    create_paragraph("4.2.1 Static Baseline Characterization", italic=True)
)
section_42_content.append(
    create_paragraph(
...
# 4.2.2
section_42_content.append(
    create_paragraph("4.2.2 Adaptive Control Under Increased Risk", italic=True)
)
section_42_content.append(
    create_paragraph(
...
# 4.2.3
section_42_content.append(
    create_paragraph("4.2.3 Adaptive Control Under Severe Risk", italic=True)
)
section_42_content.append(
    create_paragraph(
