...
| **E1 / CSSU split** | ¿La contención no fungible mueve el valor de la acción? | Gate A `PASS`; Gate B físico de Op11 `HOLD`; headroom sano `0` | interfaz CSSU viva; no Op11 físico validado ni prima neural |
