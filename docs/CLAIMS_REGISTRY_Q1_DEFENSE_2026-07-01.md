...
| C28 | In the engineered R21 compounding-starvation regime, adding heterogeneous strategic-buffer targets to the Track B action contract improves the jointly trained policy, but the improvement is reserve-posture value rather than event anticipation or weekly buffer scheduling. | **Supported for contract value; dynamic/preventive attribution pending the retrained fixed-posture baseline** | Pre-registered Gate 1 establishes physical reserve headroom only in the high-frequency/high-impact region: always-prepared minus never-prepared `+0.0299`, CI95 `[+0.0142,+0.0478]`; natural-to-moderate cells are null. Confirmatory PPO-11D minus PPO-8D is `+0.028488`, seed-clustered CI95 `[+0.015813,+0.041163]`, 5/5 seeds positive. The original timing decomposition is withdrawn. Same-checkpoint controls find schedule value `+0.000153`, CI95 `[−0.000899,+0.001206]`, with pre/post-event components null. A disjoint 12-episode calibration freezes the global `(Op3,Op5,Op9)=(0.1531,0.2480,0.2068)` posture and matches the dynamic checkpoint: frozen `0.340321` versus self `0.340164`, self-minus-frozen CI95 `[−0.000746,+0.000433]`. R11 evidence is retracted. Confirmatory holding-price significance is clean only near `lambda_h=0.05`, crossover about 0.138. | Keep outside Paper 1. Paper 2 may claim contract-regime reserve headroom and a learned joint reserve posture. Do not claim anticipation, state-contingent scheduling, or that dynamic buffer control is required until an 8D policy trained under the frozen posture is compared. Real-KAN-11D parity is a sidecar; KAN-8D remains unmatched. Primary sources: `docs/TRACK_BP_GATE2_SCREEN_VERDICT_2026-07-09.md`, `outputs/experiments/track_bp_timing_within_2026-07-09/`, and `outputs/experiments/track_bp_frozen_posture_audit_5seed_2026-07-09/`. |
