# Garrido–WRAP claim ledger — 2026-08-01

Este ledger es la frontera de claims del artículo activo Garrido–WRAP/v0. Program Q permanece
fuera de este artículo.

| claim | artefacto principal | estado | permitido | prohibido |
|---|---|---|---|---|
| Cobertura de fuentes | `results/garrido_wrap_source_audit/result.json` | `DEVELOPMENT_SOURCE_AUDIT` | Cf1–Cf20 como libros entregados; Cf21–Cf90 como regeneración | llamarlo reproducción conductual exacta |
| Figura 5 literal | `results/garrido_wrap_q1/result.json` | `DEVELOPMENT_FIG5_SURROGATE` | `drivers → ReT` es identidad | presentarlo como aprendizaje |
...
Un claim sólo pasa a manuscrito cuando su artefacto contiene contrato, hash de código, semillas,
falsadores, estado y ruta de reproducción. Un resultado retirado se conserva y se etiqueta; no se
borra ni se recicla como evidencia.
