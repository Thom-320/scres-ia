...
RecurrentPPO as a comparator); other algorithms (SAC, TD3) were not tested,
though the reward-insensitivity finding suggests algorithmic choice is
secondary to action-space alignment in this regime. Sixth, the
...
risk/horizon cell. Finally, the evidence supports adaptive recovery and
backlog control, not unqualified anticipation, retained cross-campaign
learning, universal cost reduction, or a universal law that bottleneck access
alone is sufficient for RL success.
