...
control against dense static frontiers. Retained cross-campaign learning
is not claimed in this paper; it remains a future-work question once the
winning controllable interface is fixed.
...
contract)---PPO improves Garrido/Excel resilience (ReT) by 0.000426
(95\% CI entirely positive) over the best of a dense downstream-dispatch grid of 147 static
dispatch comparators under paired common-random-number evaluation, with
