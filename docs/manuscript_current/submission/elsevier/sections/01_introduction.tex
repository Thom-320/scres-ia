...
Garrido-native risk levels at both evaluated horizons, is mixed under
severe risk, and two independent tests rule out that the effect depends
on the learned policy exploiting privileged simulator observation fields
unavailable to static comparators. The paper's central argument is
