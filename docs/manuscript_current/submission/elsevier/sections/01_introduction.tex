...
\caption{Paper framing: Track A leaves the downstream recovery bottleneck fixed, while Track B exposes downstream dispatch authority and creates a controllable adaptive-recovery frontier.}
