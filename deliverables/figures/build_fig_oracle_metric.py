...
mpc = pol["frozen_c256_mpc_retained"]["hindsight_static_in_sample"]["pooled"][
    "pooled_ratio"
]
...
axb.text(0.985, mpc, "retained belief-MPC (+0.74 on historical hindsight-bar scale)",
         transform=axb.get_yaxis_transform(), ha="right", va="bottom", fontsize=6.0,
         color=ORANGE)
axb.text(0.985, 0.0, "historical in-sample static bar", transform=axb.get_yaxis_transform(),
         ha="right", va="bottom", fontsize=6.2, color=GREEN)
...
axb.set_title("(b) Historical pilot (unmatched retention; hindsight-bar scale)",
