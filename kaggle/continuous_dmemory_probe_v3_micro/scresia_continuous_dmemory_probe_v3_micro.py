"""Kaggle kernel: continuous_its retained-reset memory micro probe.
...
LOCAL_OUTPUT_ROOT = Path("outputs/kaggle/continuous_dmemory_probe_v3_micro")
...
def profile() -> tuple[str, dict[str, str]]:
    name = (os.environ.get("SCRESIA_PROFILE") or "micro").strip()
