"""Kaggle kernel: final confirmatory for the preventive resource-aware Pareto lane.
...
KAGGLE_OUTPUT_ROOT = Path("/kaggle/working/scresia_preventive_pareto_final_outputs")
LOCAL_OUTPUT_ROOT = Path("outputs/kaggle/preventive_pareto_final")
...
def main() -> int:
    ...
    case = "preventive_pareto_excel_delta_mixed10_60k"
