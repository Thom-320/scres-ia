...
| `shift_control`  | `MFSCGymEnvShifts` | 5-dim   | `rt_v0`, `ReT_thesis`, `control_v1`  |
...
1. **Control reward benchmark** (`scripts/benchmark_control_reward.py`) -- Multi-seed PPO vs static S1/S2/S3 policies under `control_v1`. Supports weight-grid screening ("survivors") before PPO training. Outputs metrics CSV with CI95.
