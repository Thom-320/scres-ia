...
| 2026-09-09 | C&IE formatting, cover letter and submission metadata finalized | Thom + corresponding author | DRAFTS_READY_APPROVAL_PENDING | `COVER_LETTER_DRAFT.md`, `submission_metadata.json`, and `SUBMISSION_HANDOFF.md`; placeholder-free author-approved versions remain required |
