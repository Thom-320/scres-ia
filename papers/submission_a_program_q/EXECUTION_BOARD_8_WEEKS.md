...
| 2026-07-29 | Author order, affiliations, corresponding author and CRediT approved | Thom + all authors | AWAITING_COAUTHOR_RESPONSE | Evidence update sent to Prof. Garrido on 2026-07-28 local time; Gmail message `19fabe02fc3e2f68`; signed/dated update to `AUTHORSHIP_AND_PORTFOLIO.md` remains required |
...
| 2026-08-05 | Security and public-release review of military-model wording and assets | Thom + designated reviewer | PACKET_READY_REVIEW_PENDING | `SECURITY_AND_DISCLOSURE_CHECKLIST.md`; signed decision plus any redaction commit remains required |
...
| 2026-08-19 | Independent scientific and language review with every actionable comment adjudicated | Independent reviewer + Thom | PACKET_READY_REVIEW_PENDING | `INDEPENDENT_REVIEW_PACKET.md`; completed review log and resolution commits remain required |
| 2026-08-26 | Clean-room evidence-package regeneration from pinned environment | Reproducibility reviewer | RC1_PASS_FINAL_TAG_RERUN_PENDING | Fresh shallow clone resolved `31ec004e`; local 5/5 tests, tracked generated-file/source identity, 16-page TeX build and visual review passed; Kaggle Linux RC1 v2 independently resolved the same commit, regenerated eight byte-identical evidence tables and eight expected figure outputs, preserved source identity, and passed 5/5 tests; receipts are under `results/program_q/submission_a_cie_rc1_local_cleanroom/` and `results/program_q/submission_a_kaggle_cleanroom_rc1/`; final tag rerun remains required after human approvals |
| 2026-09-02 | Immutable release/tag and archival evidence bundle | Thom | RC1_COMPLETE_FINAL_RELEASE_PENDING | RC1 tag `submission-a-program-q-cie-rc1-2026-07-28`, GitHub prerelease and checksummed source/PDF assets exist; final tag and DOI wait for approvals |
| 2026-09-09 | C&IE formatting, cover letter and submission metadata finalized | Thom + corresponding author | TECHNICAL_PACKAGE_READY_APPROVAL_PENDING | Current guide audited; abstract/keywords/highlights comply; separate title-page template, AI declaration and identity-guarded anonymous bundle builder prepared. `COVER_LETTER_DRAFT.md`, `submission_metadata.json`, and `SUBMISSION_HANDOFF.md` still require placeholder-free author approval |
