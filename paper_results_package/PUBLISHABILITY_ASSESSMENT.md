...
1. Write Sections 3, 5, 6, 7
2. Send draft of results sections to Garrido for feedback
3. Decide on IJPR vs C&IE based on Garrido's journal preference

### Before submission

1. Run `reproduce_paper.sh --smoke` on a clean machine
2. Proofread with Garrido and David
3. Submit to IJPR (or C&IE if preferred)
